...
using Microsoft.PowerShell.Authoring.Framework.Logging;
using Microsoft.PowerShell.Authoring.Framework.Providers;
using System;
...
namespace Microsoft.PowerShell.Authoring.Framework.Components
{
    /// <summary>
